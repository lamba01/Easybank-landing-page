...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row ipad:h-[500px] gap-10 md:gap-0 items-center w-screen justify-between md:pl-20 md:pb-6 pb-14 overflow-hidden bg-white">
